...
for user in secure-auth secure-gmail secure-inference; do
...
d /run/secure-auth 0750 secure-auth secure-gmail -
...
systemctl stop secure-gmail.service secure-auth.service secure-inference.service
systemctl enable --now secure-auth.socket secure-gmail.socket secure-inference.socket
